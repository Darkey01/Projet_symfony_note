 ...
 */
class Version20171215105853 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE proprietaire (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(100) NOT NULL, mail VARCHAR(100) NOT NULL, password VARCHAR(100) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE message ADD CONSTRAINT FK_B6BD307F79F37AE5 FOREIGN KEY (id_user_id) REFERENCES proprietaire (id)');
        ...
        $this->addSql('ALTER TABLE personnesConversations ADD CONSTRAINT FK_D0C86C7EA76ED395 FOREIGN KEY (user_id) REFERENCES proprietaire (id)');
        ...
        $this->addSql('ALTER TABLE personnesCharges ADD CONSTRAINT FK_8504FA62A76ED395 FOREIGN KEY (user_id) REFERENCES proprietaire (id)');
        $this->addSql('ALTER TABLE personnesCharges ADD CONSTRAINT FK_8504FA6255284914 FOREIGN KEY (charge_id) REFERENCES charge (id)');
        $this->addSql('ALTER TABLE personnesProjet ADD CONSTRAINT FK_6BDEF29AA76ED395 FOREIGN KEY (user_id) REFERENCES proprietaire (id)');
        $this->addSql('ALTER TABLE personnesProjet ADD CONSTRAINT FK_6BDEF29AC18272 FOREIGN KEY (projet_id) REFERENCES projet (id)');
        $this->addSql('ALTER TABLE Votes ADD CONSTRAINT FK_904A55CBA76ED395 FOREIGN KEY (user_id) REFERENCES proprietaire (id)');
        $this->addSql('ALTER TABLE Votes ADD CONSTRAINT FK_904A55CBCF18BB82 FOREIGN KEY (reponse_id) REFERENCES reponse_sondage (id)');
        $this->addSql('ALTER TABLE activite ADD CONSTRAINT FK_B8755515764D0490 FOREIGN KEY (redacteur_id) REFERENCES proprietaire (id)');
        ...
        $this->addSql('ALTER TABLE projet ADD CONSTRAINT FK_50159CA976C50E4A FOREIGN KEY (proprietaire_id) REFERENCES proprietaire (id)');
        ...
        $this->addSql('ALTER TABLE versement ADD CONSTRAINT FK_716E936776C50E4A FOREIGN KEY (proprietaire_id) REFERENCES proprietaire (id)');
